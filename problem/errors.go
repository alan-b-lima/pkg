// Package problem implements especialized functionalities on the domain of
// Go's error handling.
//
// This package constructs over the foundation of the [error] interface and
// [errors] package, as well as HTTP status codes. Also takes inspiration - and
// the package name - from RFC 9457 about ploblem details, altough not
// complient to it.
package problem
...
// IsExternal identifies whether the error falls under the external category,
// see [Kind].
